...
with col2:
    ...
    st.metric("↩️ Corners", circuit["Corners"])

    st.metric("🏎️ Race Distance", circuit["Race Distance"])

    st.metric("🪽 DRS Zones", circuit["DRS Zones"])

st.metric("⏱️ Lap Record", circuit["Lap Record"])
...
st.markdown("## 🏎️ Track Characteristics")
